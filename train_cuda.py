...
from distributed_helpers import d_reduce, ddp_setup
...
def checkpointing(
    ...
    module: nn.Module
    if isinstance(net, DDP): module = net.module
    else: module = net
...
def train(setup: ExperimentSetup):
    ...
    rank, world_size, local_rank, device = ddp_setup().unpack()
    is_main = rank == 0
